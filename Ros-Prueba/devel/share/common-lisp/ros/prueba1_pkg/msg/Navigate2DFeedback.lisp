...
(cl:defmethod cl:initialize-instance :after ((m <Navigate2DFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate2DFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prueba1_pkg-msg:<Navigate2DFeedback> is deprecated: use prueba1_pkg-msg:Navigate2DFeedback instead.")))

(cl:ensure-generic-function 'distance_to_point-val :lambda-list '(m))
(cl:defmethod distance_to_point-val ((m <Navigate2DFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prueba1_pkg-msg:distance_to_point-val is deprecated.  Use prueba1_pkg-msg:distance_to_point instead.")
  (distance_to_point m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Navigate2DFeedback>)))
  ...
  "prueba1_pkg/Navigate2DFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Navigate2DFeedback)))
  "Returns string type for a message object of type 'Navigate2DFeedback"
  "prueba1_pkg/Navigate2DFeedback")
